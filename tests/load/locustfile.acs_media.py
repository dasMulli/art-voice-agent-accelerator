# locustfile.py
"""
ACS Media WebSocket Load Test
=============================

Tests the ACS media streaming endpoint with simulated audio turns.
...
- error/{code}      Specific error code from server
"""
import base64
import json
import os
...
def print_pipeline_info(environment, **kwargs):
    ...
    print("\n" + "=" * 60)
    print("ACS MEDIA LOAD TEST")
    print(f"  Pipeline: {pipeline_name}")
    print("  Endpoint: /api/v1/media/stream")
    print("=" * 60 + "\n")
        ...
        for _ in range(TURNS_PER_USER):
            ...
            try:
                ...
                self._record(
                    ...
                    exc=None if barge_ok else Exception("timeout"),
                )
